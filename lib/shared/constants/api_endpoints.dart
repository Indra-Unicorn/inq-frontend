class ApiEndpoints {
  ...
  static const String customerPhoneSignupInitiate = '/auth/signup/customer/phone/initiate';
  ...
  static const String getCustomerQueueHistory = '/queue-manager/customer/history';
